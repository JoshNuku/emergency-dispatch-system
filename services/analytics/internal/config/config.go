...
func Load() *Config {
	return &Config{
		Port:               getEnv("ANALYTICS_SERVICE_PORT", getEnv("PORT", "8084")),
		...
		DBSSLMode:          getEnv("ANALYTICS_DB_SSLMODE", "disable"),
		JWTSecret:          getEnv("JWT_SECRET", "dev-secret-change-in-production"),
		RabbitURL:          getEnv("RABBITMQ_URL", ""),
		DispatchServiceURL: getEnv("DISPATCH_SERVICE_URL", "http://localhost:8083"),
		IncidentServiceURL: getEnv("INCIDENT_SERVICE_URL", "http://localhost:8082"),
	}
}
